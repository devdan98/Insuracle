...
const Index = () => {
  ...
  const [userType, setUserType] = useState<"individual" | "company" | null>(
    null
  );
  ...
  if (userType === "individual") {
    return (
      <InsuracleDashboard
        setUserType={setUserType as unknown as (userType: string) => void}
      />
    );
  }
          ...
          <Menubar className="bg-transparent border-none h-14">
            ...
            <MenubarMenu>
              ...
              <MenubarContent className="bg-gray-900 border-gray-700">
                <MenubarItem className="text-white hover:bg-gray-800">
                  Company Info
                </MenubarItem>
                <MenubarItem className="text-white hover:bg-gray-800">
                  How It Works
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <h1 className="text-5xl font-bold text-white">Insuracle</h1>
          </div>
        </div>

        <div className="text-center mb-12">
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            The world's first decentralized flood insurance oracle. Providing
            real-time flood risk assessment and automated insurance claims
            ...
            <CardContent className="p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-white/90">
                <div className="text-center">
                  ...
                  <p className="text-sm">
                    Smart contracts ensure transparent and automated claim
                    processing without intermediaries.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm">
                    Advanced weather monitoring and AI-powered risk assessment
                    for accurate flood predictions.
                  </p>
                </div>
                <div className="text-center">
                  ...
                  <p className="text-sm">
                    Powered by a global network of data providers and insurance
                    partners.
                  </p>
                </div>
              </div>
        ...
        <div className="text-center mt-16 text-white/60">
          <p>
            &copy; 2025 Insuracle. Revolutionizing flood insurance through
